...
var user_configuration={
	...
	final_size:"100px", //final size of the stars after expansion
	...
	colors:["#426C9A", "#B2A8E9","#F9B0E2","#D6B960","#C0848D"], //The variety of colors of the stars. Can be any CSS complient color (eg. HEX, rgba, hsl)
	frequency:450, //how often a new wave of stars pop-out (in milliseconds. Bigger==longer)
